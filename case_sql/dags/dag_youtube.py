...
def scrape() :  
    ...
    #create scrapper object and run it
...
def scrape_and_load() :
    ...
    for i in df_result.detailed_video_rank.unique().tolist() :
         print(i)
